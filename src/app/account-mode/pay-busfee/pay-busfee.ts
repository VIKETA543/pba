...
@Component({
  ...
  imports: [ToastModule,
    ...
    DialogModule,
    MessageModule],
  templateUrl: './pay-busfee.html',
  styleUrl: './pay-busfee.css',
    providers: [MessageService]
})
export class PayBusfee {
  ...
  getAccountHistory = () => {
    ...
    this.learnerAccountservice.loadBusHistory(data).subscribe((response: any) => {
      if (response?.message) {
  ...
  loadFeebalance = () => {
    ...
    this.learnerAccountservice.loadBusbalance(data).subscribe((response: any) => {
      if (response?.message) {
        this.message = response?.message
        this.messageservice.add({ severity: 'error', summary: 'Messgae', detail: this.message });
      } else {
  ...
  submiPayment = () => {
    ...
    this.learnerAccountservice.postBusPayment(data).subscribe((response: any) => {
      if (response?.message) {
        this.message = response?.message
  ...
  genranCode = () => {
    ...
    this.PaymentNumber = "LBS-BL-" + new Date().getFullYear() + randomInteger
  }
}
