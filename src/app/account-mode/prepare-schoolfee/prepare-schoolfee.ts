...
@Component({
  ...
  templateUrl: './prepare-schoolfee.html',
  styleUrl: './prepare-schoolfee.css',
})
export class PrepareSchoolfee implements OnInit {
...
this.isCurrentBill=$event.checked
  ...
  loadCurrentFee = () => {
    ...
    this.billService.loadCurrentFee(data).subscribe((response: any) => {
      if (response?.message) {
        this.message = response?.message
        this.messageService.add({ severity: 'danger', summary: 'Messgae', detail: this.message });
      } else {
  ...
  getFeeinArrears = () => {
    ...
    this.billService.getFeeinArrears(data).subscribe((response: any) => {
      if (response?.message) {
        this.message = response?.message
        this.messageService.add({ severity: 'danger', summary: 'Messgae', detail: this.message });
      } else {
...
submitFee=()=>{
  ...
  this.billService.submitCurrentBill(data).subscribe((response:any)=>{
...
leanerFeeHistory=()=>{
  ...
  this.billService.leanerFeeHistory(data).subscribe((response:any)=>{
    if(response?.message){
      this.message = response?.message
        this.messageService.add({ severity: 'danger', summary: 'Messgae', detail: this.message });
    }else{
...
this.billService.dropLearnerbill(data).subscribe((response:any)=>{
  if (response?.message) {
        this.message = response?.message
        this.messageService.add({ severity: 'danger', summary: 'Messgae', detail: this.message });
      } else {
