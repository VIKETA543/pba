...
@Component({
  ...
  imports: [ToastModule,
    ...
    DialogModule,
    MessageModule],
  templateUrl: './pay-schoolfee.html',
  styleUrl: './pay-schoolfee.css',
  providers: [MessageService]
})
export class PaySchoolfee implements OnInit {
  ...
  getAccountHistory = () => {
    ...
    this.learnerAccountservice.loadPaymentHistory(data).subscribe((response: any) => {
      if (response?.message) {
  ...
  loadFeebalance = () => {
    ...
    this.learnerAccountservice.loadFeebalance(data).subscribe((response: any) => {
      if (response?.message) {
        this.message = response?.message
        this.messageservice.add({ severity: 'error', summary: 'Messgae', detail: this.message });
      } else {
  ...
  submiPayment = () => {
    ...
    this.learnerAccountservice.postPayment(data).subscribe((response: any) => {
      if (response?.message) {
        this.message = response?.message
