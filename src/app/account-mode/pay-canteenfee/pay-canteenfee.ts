...
@Component({
  ...
  imports: [ToastModule,
    ...
    DialogModule,
    MessageModule],
  templateUrl: './pay-canteenfee.html',
  styleUrl: './pay-canteenfee.css',
    providers: [MessageService]
})
export class PayCanteenfee {
  ...
  getAccountHistory = () => {
    ...
    this.learnerAccountservice.loadCanteenHistory(data).subscribe((response: any) => {
      if (response?.message) {
  ...
  loadFeebalance = () => {
    ...
    this.learnerAccountservice.loadCanteenbalance(data).subscribe((response: any) => {
      if (response?.message) {
        this.message = response?.message
        this.messageservice.add({ severity: 'error', summary: 'Messgae', detail: this.message });
      } else {
  ...
  submiPayment = () => {
    ...
    console.log(data)
    this.learnerAccountservice.postCanteenPayment(data).subscribe((response: any) => {
      if (response?.message) {
        this.message = response?.message
