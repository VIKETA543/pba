...
@Component({
  ...
  imports: [ToastModule,
    ...
    DialogModule,
    MessageModule],
  templateUrl: './pay-speciallevy.html',
  styleUrl: './pay-speciallevy.css',
    providers: [MessageService]
})
export class PaySpeciallevy {
  ...
  getAccountHistory = () => {
    ...
    this.learnerAccountservice.loadsepciallevyHistory(data).subscribe((response: any) => {
      if (response?.message) {
  ...
  loadFeebalance = () => {
    ...
    this.learnerAccountservice.loadspeciallevybalance(data).subscribe((response: any) => {
      if (response?.message) {
        this.message = response?.message
        this.messageservice.add({ severity: 'error', summary: 'Messgae', detail: this.message });
      } else {
  ...
  submiPayment = () => {
    ...
    this.learnerAccountservice.postspeciallevyPayment(data).subscribe((response: any) => {
      if (response?.message) {
        this.message = response?.message
  ...
  genranCode = () => {
    ...
    this.PaymentNumber = "SPL-BL-" + new Date().getFullYear() + randomInteger
  }
}
